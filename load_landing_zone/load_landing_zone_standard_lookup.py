...
if __name__ == '__main__':
    ...
    # finding and parsing table_name arg to be provided to the function
    for arg in sys.argv:
    ...
    if table_name is not None:
        ...
        load_lz_standard_lookup(table_name)

    else:
        raise Exception(
            'table_name argument is required to start loading, ex: table_name=L_AIRLINE_ID')
