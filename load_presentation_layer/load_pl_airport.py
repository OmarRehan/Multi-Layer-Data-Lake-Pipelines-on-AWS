...
def load_pl_airport(spark, pl_loc, pl_name, il_name):
    try:
        ...
        logging.info('AIRPORT has been loaded in the Presentation layer')

    except Exception as e:
        logging.error('Failed to load AIRPORT in the Presentation Layer')
        spark.stop()
        raise Exception(f'Failed to load AIRPORT in the Presentation Layer,{e}')
